...
:uri-assertj: https://assertj.github.io/doc/
:uri-junit5: https://junit.org/junit5/
:uri-mockito: https://site.mockito.org/
...
* {uri-junit5}[JUnit 5] - Primary testing framework
* JUnit 4 - Legacy tests (being migrated to JUnit 5)
* {uri-assertj}[AssertJ] - Fluent assertions
* {uri-mockito}[Mockito] - Mocking framework for Java interop
...
* Use MockK for mocking Kotlin classes (Mockito for Java interop only)
