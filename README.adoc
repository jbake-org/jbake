...
If you are running into this issue you can add the `-XX:MaxDirectMemorySize` JVM Option to your _gradle.properties_ file.

```
org.gradle.jvmargs=-XX:MaxDirectMemorySize=1g
```
