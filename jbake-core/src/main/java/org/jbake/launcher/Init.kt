        ...
        if (contents != null) {
            for (content in contents) {
                if (content.isDirectory()) {
                    if (content.getName().equals(config.templateFolderName, ignoreCase = true)) {
                        safe = false
                    }
                    if (content.getName().equals(config.contentFolderName, ignoreCase = true)) {
                        safe = false
                    }
                    if (content.getName().equals(config.assetFolderName, ignoreCase = true)) {
                        safe = false
                    }
                }
            }
